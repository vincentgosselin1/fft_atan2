...
# ACDS 17.1 590 win32 2020.02.16.18:11:35
...
# ----------------------------------------
# If cordic_atan2_v1 is one of several IP cores in your
...
TOP_LEVEL_NAME="cordic_atan2_v1"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cordic_atan2_v1_CORDIC_0.vhd" -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cordic_atan2_v1.vhd"                                                                       
fi
